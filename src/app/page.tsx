...
const cvData = {
  ...
  projects: [
    ...
    },
    {
      ...
      category: ["Unity", "Game"],
      desc: {
        en: "3D physics-based simulation with cross-platform optimization.",
        id: "Simulasi berbasis fisika 3D dengan optimasi lintas platform.",
      },
    ...
    },
    {
      ...
      desc: {
        en: "Word randomization system with local DB and monetization.",
        id: "Sistem pengacakan kata dengan database lokal dan monetisasi.",
      },
